...
async function main() {
    const contractName = "PrivacyBridgeWADA";
    ...
    const outPath = path.join(__dirname, "..", "..", `PrivacyBridgeWADA_ExactInput.json`);
    ...
    console.log(`3. Upload the PrivacyBridgeWADA_ExactInput.json file`);
}
