...
async function main() {
  ...
  console.log("================================================");
  console.log("  🚀 REDEPLOYING 5 ERC20 PRIVACY BRIDGES");
  ...
  for (const bridge of BRIDGES) {
    ...
    console.log(`  Granting MINTER_ROLE on ${bridge.privateFactory} to new bridge...`);
  ...
  console.log("\n================================================");
  console.log("  ✅ ALL 5 BRIDGES DEPLOYED");
  console.log("================================================");
  for (const [name, addr] of Object.entries(results)) {
    console.log(`  ${name}: "${addr}",`);
  }
  console.log("\nUpdate src/contracts/config.ts with the addresses above.");
}
