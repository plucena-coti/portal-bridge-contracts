...
async function main() {
    const contractName = "PrivacyBridgeWETH";
    ...
    const outPath = path.join(__dirname, "..", "..", `PrivacyBridgeWETH_ExactInput.json`);
    ...
    console.log(`3. Upload the PrivacyBridgeWETH_ExactInput.json file`);
}
