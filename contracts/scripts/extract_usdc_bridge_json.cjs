...
async function main() {
    const contractName = "PrivacyBridgeUSDCe";
    ...
    const outPath = path.join(__dirname, "..", "..", `PrivacyBridgeUSDCe_ExactInput.json`);
    ...
    console.log(`3. Upload the PrivacyBridgeUSDCe_ExactInput.json file`);
}
