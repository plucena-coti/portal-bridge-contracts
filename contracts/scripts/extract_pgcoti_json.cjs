...
async function main() {
    const contractName = "PrivateCOTITreasuryGovernanceToken";
    ...
    const outPath = path.join(__dirname, "..", "..", `pgCOTI_ExactInput.json`);
    ...
    console.log(`3. Upload the pgCOTI_ExactInput.json file`);
}
