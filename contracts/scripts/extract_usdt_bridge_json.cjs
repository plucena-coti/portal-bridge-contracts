...
async function main() {
    const contractName = "PrivacyBridgeUSDT";
    ...
    const outPath = path.join(__dirname, "..", "..", `PrivacyBridgeUSDT_ExactInput.json`);
    ...
    console.log(`3. Upload the PrivacyBridgeUSDT_ExactInput.json file`);
}
