...
async function main() {
    const contractName = "PrivacyBridgegCoti";
    ...
    const outPath = path.join(__dirname, "..", "..", `PrivacyBridgegCoti_ExactInput.json`);
    ...
    console.log(`3. Upload the PrivacyBridgegCoti_ExactInput.json file`);
}
